global using testrpg.Models;
global using testrpg.Services.CharacterService;
global using testrpg.Dtos.Character;
...
{
    Description = "bla bla de base. Exemple: bearer {token}",
    Name = "Authorization",
